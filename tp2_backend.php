...
if ( $numero1 > $numero2 ){
    ...
    echo "La multiplicacion de las dos variables es : " . ($numero1*$numero2) . "<br> La divicion de las dos variables es : " . ($numero2/$numero1) . "<br> El resto de las dos variables es: " . ($numero1%$numero2);
} else {
